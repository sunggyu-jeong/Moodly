...
import PopupButton from "../atoms/ModalButton.atm";
    ...
    <View className="h-[80px] justify-center items-center flex-row mx-9 gap-[10px]">
      {
        ...
        <PopupButton text={cancelText} textColor="#212123" onPress={onCancel} />
      }
      {
        isNotEmpty(confirmText) &&
        <PopupButton text={confirmText} textColor="white" bgColor="#212123" onPress={onConfirm} />  
      }
    </View>
  );
}
